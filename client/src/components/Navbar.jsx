        ...
        <div className="flex items-center justify-end">
          {loading ? (
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link to="/dashboard" className="rounded-full px-3 py-2 text-sm font-medium text-stone-600 transition hover:bg-white hover:text-stone-900 hover:shadow-sm">
                Dashboard
              </Link>
              <button type="button" onClick={handleLogout} className="rounded-full border border-stone-200 bg-white/80 px-4 py-2 text-sm font-medium text-stone-700 shadow-sm transition hover:border-stone-300 hover:bg-white">
                Log out
              </button>
            </div>
          ) : (
