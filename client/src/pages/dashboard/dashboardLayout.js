/** Full-bleed dashboard content width — matches navbar edge padding. */
export const DASHBOARD_SHELL_MAX = 'min(100rem, calc(100vw - 2rem))';
...
export const DASHBOARD_GRID_SAVED =
  'grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5';

export const DASHBOARD_GRID_STATS =
  'grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4 lg:gap-5 xl:gap-6';
