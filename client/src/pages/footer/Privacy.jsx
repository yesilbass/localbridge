        ...
        return (
            <main className={`${pageShell} relative px-4 py-20 sm:px-6 sm:py-24 lg:px-8`}>
                    <div
                        ...
                        style={{
                            background:
                                'conic-gradient(from 240deg at 50% 50%, color-mix(in srgb, var(--color-primary) 12%, transparent), color-mix(in srgb, var(--color-accent) 8%, transparent), color-mix(in srgb, var(--color-primary) 14%, transparent), color-mix(in srgb, var(--color-primary) 12%, transparent))',
                            filter: 'blur(90px)',
                        }}
                    />
