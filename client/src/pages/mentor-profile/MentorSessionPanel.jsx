    ...
    <div aria-label="Mentor stats">
      {rating > 0 ? (
        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
          <span
            className="inline-flex items-center rounded-full px-2.5 py-1 font-black uppercase whitespace-nowrap"
            style={{
              fontSize: '10px',
      ...
      <div className="mt-3 flex flex-wrap items-center gap-x-5 gap-y-1.5 text-sm" style={{ color: 'var(--bridge-text-muted)' }}>
...
export default function MentorSessionPanel({
  ...
  return (
    <aside
      className={`relative flex w-full shrink-0 flex-col overflow-hidden sm:gap-7 lg:sticky lg:self-start ${
        inHeroShell
          ? 'gap-6 border-t pt-8 sm:gap-7 sm:p-0 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-10'
          : 'gap-7 rounded-[1.35rem] p-7 sm:p-8 lg:w-[440px]'
      }`}
      style={{
        top: stickyTop,
        ...(inHeroShell
          ? { backgroundColor: 'transparent', borderColor: 'var(--bridge-border)' }
          : {
